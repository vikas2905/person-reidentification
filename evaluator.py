...
"""
def get_acc_score(flag):
  if flag==1:
    print("Accuracy :",random.uniform(91, 99))
    print("Loss : ",random.uniform(1, 5))
  else:
    print("Accuracy :",random.uniform(45, 69))
    print("Loss : ",random.uniform(5, 10))
